export function JerseyMarker({
  ...
  const bodyColor = isGoalkeeper ? gkJerseyColor : jerseyColor;
  const textColor = isGoalkeeper ? gkNumberColor : numberColor;
    ...
    return (
      <div className="relative" style={{ width: size, height: size }}>
        <img
          ...
          style={{ border: `2px solid ${bodyColor}` }}
        />
        {number !== undefined && (
          <span
  ...
  return (
    <div className="flex flex-col items-center" style={{ width: size }}>
      <svg width={size} height={size} viewBox="0 0 100 100">
        ...
        {/* collar */}
        <path
          d="M40 15 Q50 24 60 15 L58 20 Q50 27 42 20 Z"
          fill={collarColor}
        />
